...
|----------|---------|-----------|----------|
| **GPIO 21** | Rundsav | Grøn (OPEN) / Rød (CLOSED) | Gate status indikator |
| **GPIO 26** | Disponibel | Grøn / Rød | Gate status indikator |
| **GPIO 16** | Lille CNC | Grøn / Rød | Gate status indikator |
| **GPIO 13** | Stor CNC | Grøn / Rød | Gate status indikator |
| **GPIO 19** | Rondelsliber | Grøn / Rød | Gate status indikator |
| **GPIO 6** | Båndsliber | Grøn / Rød | Gate status indikator |
| **GPIO 12** | Vacuum | Orange / Rød | Udsugning aktiv |
...
| **GPIO 11** | Sensor | INPUT | Disponibel gate position sensor |
...
□ GPIO 26 (Disponibel)    – LED tændt når gate åbent?
